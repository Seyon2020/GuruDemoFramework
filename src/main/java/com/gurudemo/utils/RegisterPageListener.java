...
/**
 * A simple RegisterPageListener which listen to all the test cases
 * of RegisterPage Test and logs all the status to the RegisterPageReport.
 * It attaches screenshot of failed test cases to the report. 
 * */
public class RegisterPageListener extends TestListenerAdapter{
public static ExtentReports extent;
public static ExtentTest logger;
public void onStart(ITestContext testContext) {
extent=ExtentReportManager.getReportInstance("RegisterPage");	
}

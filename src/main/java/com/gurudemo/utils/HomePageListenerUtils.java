...
/**
 * A simple HomePageListenerUtils which listen to all the test cases
 * of HomePage Test and logs all the status to the HomePageReport.
 * It attaches screenshot of failed test cases to the report. 
 * */

public class HomePageListenerUtils extends TestListenerAdapter{
public static ExtentReports extent;
public static ExtentTest logger;
public void onStart(ITestContext testContext) {
extent=ExtentReportManager.getReportInstance("HomePage");	
}

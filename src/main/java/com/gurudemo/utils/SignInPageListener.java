...
/**
 * A simple SignInPageListener which listen to all the test cases
 * of SignInPage Test and logs all the status to the SignInPageReport.
 * It attaches screenshot of failed test cases to the report. 
 * */
public class SignInPageListener extends TestListenerAdapter{
public static ExtentReports extent;
public static ExtentTest logger;
public void onStart(ITestContext testContext) {
extent=ExtentReportManager.getReportInstance("SigInPage");	
}
